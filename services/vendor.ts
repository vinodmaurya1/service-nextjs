...
export const vendorService = {
  getAll: (params?: ParamsType) =>
    fetcher<Paginate<Shop>>(buildUrlQueryParams("v1/rest/vendor-list/paginate", params)),
  create: (data: CreateShopCredentials) => fetcher.post("v1/auth/verify/vendor-phone", { body: data }),
