...
const Vendor = dynamic(
  () => import("./components/vendor").then((component) => ({ default: component.Vendor })),
  {
    ssr: false,
    loading: () => (
      <div className=" my-7">
...
const Master = dynamic(
  () => import("./components/master").then((component) => ({ default: component.Master })),
  {
    ssr: false,
    loading: () => (
      <div className=" my-7">
...
const HomePage = async () => {
  ...
  const vendor = await vendorService.getAll({ lang, perPage: 8 });
  const master = await masterService.list({ lang, perPage: 8 });
          ...
          <div className="grid md:grid-cols-2 lg:gap-48 mb-10">
            <div className="px-4 xl:px-0">
              <h1 className="lg:text-[65px] md:text-5xl text-3xl break-words leading-normal text-center md:text-start">
                ...
                <Translate value="in.the.best.service.near.you" />
              </h1>
